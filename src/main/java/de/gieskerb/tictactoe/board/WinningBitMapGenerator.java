...
public class WinningBitMapGenerator {
    ...
    private static long[][] allBitMapsPerSize = new long[7][];

    public static long[] getBitMaps(byte boardSize) {
        ...
        if (allBitMapsPerSize[boardSize-2] == null) {
            allBitMapsPerSize[boardSize-2] = createAllBitMaps(boardSize);
        }
